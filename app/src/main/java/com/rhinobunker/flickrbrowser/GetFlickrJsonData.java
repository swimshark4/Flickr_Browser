...
public class GetFlickrJsonData extends GetRawData {
    ...
    public GetFlickrJsonData(String searchCriteria, boolean matchAll) {
        super(null); // here to keep from crashing, constructor for GetRawData requires a url which we don't have here. This processes null and returns null
    ...
    public boolean createAndUpdateUri(String searchCriteria, boolean matchAll) {
        final String FLICKR_API_BASE_URL = "https://api.flickr.com/services/feeds/photos_public.gne?tags=android,lollipop&format=json&nojsoncallback=1";
